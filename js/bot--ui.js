    ...
    var tui = function(){
        ...
        content: "给爷吃！" //内容
            ...
            botui.message.add({
                ...
                loading: true,
                delay: 1000,
                content: '<img src="https://cdn.staticaly.com/gh/conquer1the2world3/zfsjlll-blog@main/Photo/mmexport1689240885937.oaknsq9z6q8.jpg" alt="狗粮"><br>--------------------------------------------------<br>达成成就【狗粮陷阱】width="128" height="170"'
            }).then(function(){
                botui.message.add({
                    delay:1200,
                    content:"总而言之，这两个人是通过互联网相识的。从相恋到奔现，从争吵到磕磕绊绊走到现在，也还算是一场甜甜的恋爱。如果想了解更多关于他们的故事的话，就自己去探索吧~"
